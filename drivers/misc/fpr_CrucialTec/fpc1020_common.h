...
#define FPC1020_WAIT_FINGER_PRESENT_TIMEOUT_MS	(30 * HZ / 1000)
...
#define	RET_OK					0
#define RET_FINGER_UP				1

#define HTC_FINGER_DOWN_THRESHOLD_ENROLL    0
#define HTC_FINGER_DOWN_THRESHOLD_VERIFY    0
#define HTC_FINGER_DOWN_THRESHOLD_HOME      0
...
typedef enum {
	FPC1020_FINGER_STATE_UP = 0,
	FPC1020_FINGER_STATE_DOWN,
} fpc1020_finger_state_t;
...
typedef struct fpc1020_setup {
	...
	u8 input_finger_down_threshold;
...
typedef struct {
	...
	bool		       file_opened;
	fpc1020_finger_state_t finger_state;
	struct workqueue_struct	*workqueue;
	struct work_struct	interrupt_work;
	fpc1020_fp_mode_t		fp_mode;
...
#define FPC1020_FINGER_DETECT_ZONE_MASK		0x0060U
