...
static int da9210_debug_mask;

module_param_named(
    debug_mask, da9210_debug_mask, int, S_IRUGO | S_IWUSR | S_IWGRP
);
...
void da9210_dump_register(void)
{
    ...
    da9210_config_interface(0x0, 0x0, 0xF, 0); 
...
{    
    ...
    ret = da9210_config_interface(0x0, 0x1, 0x1, 7); 
    ret = da9210_config_interface(0x5D,0x1, 0x1, 0); 
    ret = da9210_config_interface(0x58,0x44,0xFF, 0);
    ret = da9210_config_interface(0x59,0x0, 0xF, 4); 
    ret = da9210_config_interface(0x59,0x4, 0xF, 0); 
    ret = da9210_config_interface(0x5A,0x54,0xFF, 0);
    ret = da9210_config_interface(0x5D,0x0, 0x1, 4); 

    
    ret = da9210_config_interface(0x5D,0x2,0x3,5);   
    ret = da9210_config_interface(0x5D,0x0,0x3,1);   
    ret = da9210_config_interface(0xD2,0x1,0x1,4);   
    ret = da9210_config_interface(0xD6,0x64,0x7F,0); 
    ret = da9210_config_interface(0xD8,0x50,0x7F,0); 
    ...
    ret = da9210_config_interface(0xD9,0xA8,0xFF,0); 
    

    ret = da9210_config_interface(0xD1,0x3,0x3,0); 
...
{    
    ...
    ret = da9210_config_interface(0x0, 0x1, 0x1, 7); 
    ret = da9210_config_interface(0x5D,0x1, 0x1, 0); 
    ret = da9210_config_interface(0x5D,0x0, 0x1, 3); 
    ret = da9210_config_interface(0x58,0x44,0xFF, 0);
    ret = da9210_config_interface(0x59,0x0, 0xF, 4); 
    ret = da9210_config_interface(0x59,0x4, 0xF, 0); 
    ret = da9210_config_interface(0x5A,0x54,0xFF, 0);
    ...
    ret = da9210_config_interface(0xD2,0x1,0x1,4);   
    ret = da9210_config_interface(0xD6,0x64,0x7F,0); 
    ret = da9210_config_interface(0xD8,0x46,0xFF,0); 
    if(g_vproc_vsel_gpio_number!=0)
    {
        ext_buck_vproc_vsel(1); 
        xlog_printk(ANDROID_LOG_INFO, "Power/PMIC", "[da9210_hw_init_v2] ext_buck_vproc_vsel(1)\n");
    }
    ret = da9210_config_interface(0xD9,0xB2,0xFF,0); 
    
    ret = da9210_config_interface(0xD1,0x0,0x3,0); 
...
void da9210_hw_component_detect(void)
{
    ...
    ret=da9210_config_interface(0x0, 0x1, 0x1, 7); 
    ret=da9210_config_interface(0x0, 0x2, 0xF, 0); 
...
int is_da9210_sw_ready(void)
{
    ...
    if (DA9210_DEBUG & da9210_debug_mask)
...
unsigned long da9210_vol_get(void)
{
	kal_uint8 val;

	val = da9210_get_reg_value(0xD8);

	return ((val * 1000) + 30000) * 10; 
}
...
void bigcore_power_init(void)
{
    ...
    else 
    {
        ...
        {
            ret = da9210_config_interface(0x5D, 0x1, 0x3, 1);    
            mt6331_upmu_set_rg_vsram_dvfs1_vosel(0);             
            mt6331_upmu_set_vsram_dvfs1_vosel_sleep(0);          
...
static DEVICE_ATTR(da9210_access, 0664, show_da9210_access, store_da9210_access); 
...
static DEVICE_ATTR(da9210_vosel_pin, 0664, show_da9210_vosel_pin, store_da9210_vosel_pin); 
