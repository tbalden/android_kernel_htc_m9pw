...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV2722MIPI_SENSOR_ID,        
...
{{ 1928, 1088, 0, 0, 1928, 1088, 1928, 1088, 0, 0, 1928, 1088, 0, 0, 1928, 1088}, 
 { 1928, 1088, 0, 0, 1928, 1088, 1928, 1088, 0, 0, 1928, 1088, 0, 0, 1928, 1088}, 
 { 1928, 1088, 0, 0, 1928, 1088, 1928, 1088, 0, 0, 1928, 1088, 0, 0, 1928, 1088}, 
 { 1928, 1088, 0, 0, 1928, 1088, 1928, 1088, 0, 0, 1928, 1088, 0, 0, 1928, 1088}, 
 { 1928, 1088, 0, 0, 1928, 1088, 1928, 1088, 0, 0, 1928, 1088, 0, 0, 1928, 1088}};
...
static void sensor_init(void)
{
    ...
    write_cmos_sensor(0x3804, 0x07);
    write_cmos_sensor(0x3805, 0x9b);
    write_cmos_sensor(0x3806, 0x04);
    write_cmos_sensor(0x3807, 0x45);
...
static void preview_setting(void)
{
    ...
    write_cmos_sensor(0x5000, 0xcd); 
    write_cmos_sensor(0x3503, 0x07); 

    write_cmos_sensor(0x4009, 0x40);  
...
static int ov2722_sysfs_init(void)
{
    ...
    if(first){
        ...
        if (android_ov2722 == NULL) {
            LOG_INF("ov2722_sysfs_init: subsystem_register " \
            "failed\n");
            ret = -ENOMEM;
            return ret ;
        }
        LOG_INF("ov2722:sysfs_create_file\n");
        ret = sysfs_create_file(android_ov2722, &dev_attr_sensor.attr);
        if (ret) {
            LOG_INF("ov2722_sysfs_init: sysfs_create_file " \
            "failed\n");
