...
#define GPIO_NFC_MT6605_CHK_PIN         (GPIO140 | 0x80000000)
...
static int __init mt6605_dev_init(void)
{
	...
	if (!mt_get_gpio_in(GPIO_NFC_MT6605_CHK_PIN))		//High: not use MT6605	Low: use MT6605
	{
  ...
  {
  	printk(KERN_DEBUG "NFC not use MT6605, mt6605 init failed.\n");	
  }
	return 0;
}
