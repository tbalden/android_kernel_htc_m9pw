...
#define TIMEOUT_RESET	    0x4E20 
#define TIMEOUT_READ	    0x4E20 
#define TIMEOUT_WAIT_IDLE	0x4E20 
...
#define MT6331_INT_STA         (PMIC_REG_BASE+0x01B4) 
#define MT6332_INT_STA         (SWCHR_REG_BASE+0x0112) 
