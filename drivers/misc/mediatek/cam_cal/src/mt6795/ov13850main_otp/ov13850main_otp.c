...
static struct i2c_board_info __initdata kd_cam_cal_dev={ I2C_BOARD_INFO(CAM_CAL_DRVNAME, OV13850MAIN_OTP_DEVICE_ID>>1)};
...
static long ov13850mainotp_Ioctl_Compat(struct file *filp, unsigned int cmd, unsigned long arg)
{
    long ret;
    COMPAT_stCAM_CAL_INFO_STRUCT __user *data32;
    stCAM_CAL_INFO_STRUCT __user *data;
    int err;
	CAM_CALDB("[CAMERA SENSOR] ov13850mainotp_Ioctl_Compat,%p %p %x ioc size %d\n",filp->f_op ,filp->f_op->unlocked_ioctl,cmd,_IOC_SIZE(cmd) );
...
#endif
extern char ov13850main_otp_data[16];
static int selective_read_region(u32 offset, BYTE* data,u16 i2c_id,u32 size)
{
    memcpy((void *)data,(void *)&ov13850main_otp_data[offset],size);
...
#endif
{
    ...
    switch(a_u4Command)
    {
        ...
        case CAM_CALIOC_G_READ:
            ...
            i4RetValue = selective_read_region(ptempbuf->u4Offset, pu1Params, OV13850MAIN_OTP_DEVICE_ID,ptempbuf->u4Length);
...
#ifdef CONFIG_COMPAT
    .compat_ioctl = ov13850mainotp_Ioctl_Compat,
#endif
...
static int CAM_CAL_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id) {
    ...
    g_pstI2Cclient->addr = OV13850MAIN_OTP_DEVICE_ID>>1;
    spin_unlock(&g_CAM_CALLock); 
