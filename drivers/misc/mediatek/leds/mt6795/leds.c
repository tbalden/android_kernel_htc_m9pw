...
extern void panel_customized_pmic_setting();
...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
	...
	case MT65XX_LED_PMIC_NLED_ISINK0:
		...
		mt6331_upmu_set_isink_ch0_step(ISINK_0);	
	...
	case MT65XX_LED_PMIC_NLED_ISINK1:
		...
		mt6331_upmu_set_isink_ch1_step(ISINK_0);	
	...
	case MT65XX_LED_PMIC_NLED_ISINK2:
		...
		mt6331_upmu_set_isink_ch2_step(ISINK_0);	
	...
	case MT65XX_LED_PMIC_NLED_ISINK3:
		...
		mt6331_upmu_set_isink_ch3_mode(PMIC_PWM_0);
		mt6331_upmu_set_isink_ch3_step(ISINK_0);	
...
int mt_brightness_set_pmic(enum mt65xx_led_pmic pmic_type, u32 level, u32 div)
{
	...
	if (pmic_type == MT65XX_LED_PMIC_LCD_ISINK) {
		if (backlight_init_flag == false) {
			mt6331_upmu_set_rg_g_drv_2m_ck_pdn(0x0);	

			
			
			mt6331_upmu_set_rg_drv_isink0_ck_pdn(0x0);	
			mt6331_upmu_set_rg_drv_isink0_ck_cksel(0x1);	
			mt6331_upmu_set_isink_ch0_mode(ISINK_PWM_MODE);
			mt6331_upmu_set_isink_ch0_step(ISINK_5);	
			mt6331_upmu_set_isink_sfstr0_en(0x0);	
			mt6331_upmu_set_rg_isink0_double_en(0x1);	
			mt6331_upmu_set_isink_phase_dly_tc(0x0);	
			mt6331_upmu_set_isink_phase0_dly_en(0x1);	
			mt6331_upmu_set_isink_chop0_en(0x1);	
			
			mt6331_upmu_set_rg_drv_isink1_ck_pdn(0x0);	
			mt6331_upmu_set_rg_drv_isink1_ck_cksel(0x1);	
			mt6331_upmu_set_isink_ch1_mode(ISINK_PWM_MODE);
			mt6331_upmu_set_isink_ch1_step(ISINK_3);	
			mt6331_upmu_set_isink_sfstr1_en(0x0);	
			mt6331_upmu_set_rg_isink1_double_en(0x1);	
			mt6331_upmu_set_isink_phase1_dly_en(0x1);	
			mt6331_upmu_set_isink_chop1_en(0x1);	
			
			mt6331_upmu_set_rg_drv_isink2_ck_pdn(0x0);	
			mt6331_upmu_set_rg_drv_isink2_ck_cksel(0x1);	
			mt6331_upmu_set_isink_ch2_mode(ISINK_PWM_MODE);
			mt6331_upmu_set_isink_ch2_step(ISINK_3);	
			mt6331_upmu_set_isink_sfstr2_en(0x0);	
			mt6331_upmu_set_rg_isink2_double_en(0x1);	
			mt6331_upmu_set_isink_phase2_dly_en(0x1);	
			mt6331_upmu_set_isink_chop2_en(0x1);	
			
			mt6331_upmu_set_rg_drv_isink3_ck_pdn(0x0);	
			mt6331_upmu_set_rg_drv_isink3_ck_cksel(0x1);	
			mt6331_upmu_set_isink_ch3_mode(ISINK_PWM_MODE);
			mt6331_upmu_set_isink_ch3_step(ISINK_3);	
			mt6331_upmu_set_isink_sfstr3_en(0x0);	
			mt6331_upmu_set_rg_isink3_double_en(0x1);	
			mt6331_upmu_set_isink_phase3_dly_en(0x1);	
			mt6331_upmu_set_isink_chop3_en(0x1);	
		...
		if (level) {
			...
			mt6331_upmu_set_isink_dim0_fsel(ISINK_2M_20KHZ);	
			mt6331_upmu_set_isink_dim1_fsel(ISINK_2M_20KHZ);	
			mt6331_upmu_set_isink_dim2_fsel(ISINK_2M_20KHZ);	
			mt6331_upmu_set_isink_dim3_fsel(ISINK_2M_20KHZ);	
			mt6331_upmu_set_isink_ch0_en(NLED_ON);	
			mt6331_upmu_set_isink_ch1_en(NLED_ON);	
			mt6331_upmu_set_isink_ch2_en(NLED_ON);	
			mt6331_upmu_set_isink_ch3_en(NLED_ON);	
		...
		mt6331_upmu_set_isink_ch0_step(ISINK_0);
		mt6331_upmu_set_isink_dim0_duty(15);
		mt6331_upmu_set_isink_dim0_fsel(ISINK_1KHZ);
		if (level) {
			mt6331_upmu_set_isink_ch0_en(NLED_ON);
		}
		else {
	...
	else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK1)
	{
		...
		mt6331_upmu_set_isink_ch1_step(ISINK_0);
		mt6331_upmu_set_isink_dim1_duty(15);
		mt6331_upmu_set_isink_dim1_fsel(ISINK_1KHZ);
		if (level) 
		{
			mt6331_upmu_set_isink_ch1_en(NLED_ON);
		}
	...
	else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK2)
	{
		...
		mt6331_upmu_set_isink_ch2_step(ISINK_0);
		mt6331_upmu_set_isink_dim2_duty(15);
		mt6331_upmu_set_isink_dim2_fsel(ISINK_1KHZ);
		if (level) 
		{
			mt6331_upmu_set_isink_ch2_en(NLED_ON);
		}
	...
	else if(pmic_type == MT65XX_LED_PMIC_NLED_ISINK3)
	{
		...
		mt6331_upmu_set_isink_ch3_step(ISINK_0);
		mt6331_upmu_set_isink_dim3_duty(15);
		mt6331_upmu_set_isink_dim3_fsel(ISINK_1KHZ);
		if (level) 
		{
			mt6331_upmu_set_isink_ch3_en(NLED_ON);
		}
