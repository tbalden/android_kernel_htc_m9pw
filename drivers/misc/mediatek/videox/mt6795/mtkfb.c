...
void mtkfb_dump_layer_info(void)
{
	...
	for (i = 0; i < 4; i++) {
		DISPMSG("[mtkfb] layer=%d, layer_en=%d, idx=%d, fmt=%d, addr=0x%x, %d, %d, %d\n ", cached_layer_config[i].layer,	
		       cached_layer_config[i].layer_en, cached_layer_config[i].buff_idx, cached_layer_config[i].fmt, cached_layer_config[i].addr,	
  ...
  DISPMSG("[mtkfb] captured(current): \n");
	for (i = 0; i < 4; i++) {
		DISPMSG("[mtkfb] layer=%d, layer_en=%d, idx=%d, fmt=%d, addr=0x%x, %d, %d, %d\n ", captured_layer_config[i].layer,	
		       captured_layer_config[i].layer_en, captured_layer_config[i].buff_idx, captured_layer_config[i].fmt, captured_layer_config[i].addr,	
  ...
  DISPMSG("[mtkfb] realtime(hw): \n");
	for (i = 0; i < 4; i++) {
		DISPMSG("[mtkfb] layer=%d, layer_en=%d, idx=%d, fmt=%d, addr=0x%x, %d, %d, %d\n ", realtime_layer_config[i].layer,	
		       realtime_layer_config[i].layer_en, realtime_layer_config[i].buff_idx, realtime_layer_config[i].fmt, realtime_layer_config[i].addr,	
			...
			case MTKFB_PREPARE_OVERLAY_BUFFER:
			{
				...
				{				
					if (overlay_buffer.layer_en) 
					{
						...
						{
							overlay_buffer.fence_fd = MTK_FB_INVALID_FENCE_FD; 
