...
static int _color_config(DISP_MODULE_ENUM module, disp_ddp_path_config* pConfig, void *cmq_handle)
{
    ...
    else
    {
        ...
        
        {
            ...
            _color_reg_set(cmdq, DISP_COLOR_CFG_MAIN + offset,(1<<7)); 
            _color_reg_set(cmdq, DISP_COLOR_START + offset, 0x00000003); 
        }
...
static int _color_bypass(DISP_MODULE_ENUM module, int bypass)
{
    ...
    {
        _color_reg_set(NULL, DISP_COLOR_CFG_MAIN + offset,(1<<29)); 
