...
#else
#define SPM_MCUCFG_BASE		(0xF0200000)      
...
static struct pcm_desc suspend_pcm = {
	.version	= "pcm_suspend_v10.6_20141208-exp8",
	.base		= suspend_binary,
	.size		= 846,
	.sess		= 2,
	.replace	= 0,
	...
	.vec2		= EVENT_VEC(30, 1, 0, 132),	
	.vec3		= EVENT_VEC(31, 1, 0, 286),	
};
...
static void spm_i2c_control(u32 channel, bool onoff)
{
    ...
    if ((1 == onoff) && (0 == i2c_onoff))
    {
       i2c_onoff = 1;
        ...
        spm_write(base + OFFSET_EXT_CONF,    0x1800); 
        spm_write(base + OFFSET_IO_CONFIG,   0x3);    
