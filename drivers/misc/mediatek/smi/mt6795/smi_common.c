...
static void vrSetting(void)
{
    ...
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB0, 0x1614);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB1, 0x1000);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB2, 0x11F7);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB3, 0x1584);  
    ...
    M4U_WriteReg32(LARB0_BASE, 0x228, 0x5); 
    M4U_WriteReg32(LARB2_BASE, 0x200, 0x8); 
    ...
    M4U_WriteReg32(LARB2_BASE, 0x22c, 0x4); 
    M4U_WriteReg32(LARB2_BASE, 0x230, 0x1); 
    M4U_WriteReg32(LARB2_BASE, 0x244, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x200, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x204, 0x4); 
    M4U_WriteReg32(LARB3_BASE, 0x208, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x20c, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x210, 0x1); 
    M4U_WriteReg32(LARB3_BASE, 0x230, 0x8); 
    M4U_WriteReg32(LARB3_BASE, 0x234, 0x4); 
    M4U_WriteReg32(LARB3_BASE, 0x23c, 0x10); 

    
    M4U_WriteReg32(LARB4_BASE, 0x200, 0x1); 
    M4U_WriteReg32(LARB4_BASE, 0x204, 0x1); 
    M4U_WriteReg32(LARB4_BASE, 0x208, 0x1c); 
    M4U_WriteReg32(LARB4_BASE, 0x20c, 0xa); 

    
    
    M4U_WriteReg32(LARB0_BASE, 0x210, 0x8);  
    M4U_WriteReg32(LARB0_BASE, 0x21C, 0x4);  
    M4U_WriteReg32(LARB0_BASE, 0x22C, 0x3);  

    
    M4U_WriteReg32(LARB1_BASE, 0x200, 0x1f); 
    M4U_WriteReg32(LARB1_BASE, 0x204, 0x06); 
    M4U_WriteReg32(LARB1_BASE, 0x208, 0x1); 
    M4U_WriteReg32(LARB1_BASE, 0x20c, 0x1); 
    M4U_WriteReg32(LARB1_BASE, 0x210, 0x1); 
    M4U_WriteReg32(LARB1_BASE, 0x214, 0x2); 
...
static void vpSetting(void)
{
    ...
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB0, 0x17C0);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB1, 0x161B);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB2, 0x1000);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB3, 0x1000);  
    M4U_WriteReg32(SMI_COMMON_EXT_BASE, REG_OFFSET_SMI_L1ARB4, 0x1000);  
    
    M4U_WriteReg32(LARB0_BASE, 0x200, 0x18); 
    M4U_WriteReg32(LARB0_BASE, 0x210, 0x8);  
    M4U_WriteReg32(LARB0_BASE, 0x21C, 0x4);  
    M4U_WriteReg32(LARB0_BASE, 0x220, 0x4);  
    M4U_WriteReg32(LARB0_BASE, 0x228, 0x5);  
    M4U_WriteReg32(LARB0_BASE, 0x22C, 0x3);  
...
static int smi_probe(struct platform_device *pdev)
{
    ...
    smi_reg_bases[0] = 0xf4022000; 
    smi_reg_bases[1] = 0xf4021000; 
    smi_reg_bases[2] = 0xf6010000;
    smi_reg_bases[3] = 0xf5001000;
    smi_reg_bases[4] = 0xf8001000;
    smi_reg_bases[5] = 0xf7002000; 
