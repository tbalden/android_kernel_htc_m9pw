...
static int ioexp_gpio_init(void)
{
	ioexp_gpio_set_cfg(CAM_I2C_ADDR,	IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CAM2_ID,		IOEXP_INPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(MAIN_CAM_ID,		IOEXP_INPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(FRONT_CAM_ID,	IOEXP_INPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(LCD_ID1,		IOEXP_INPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(LCD_ID0,		IOEXP_INPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(FLASH_EN,		IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(TORCH_FLASH,		IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CIR_3V3_EN,		IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CIR_LS_EN,		IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CIR_RST,		IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CAM2_A2V9_EN,	IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CAM2_D1V2_EN,	IOEXP_OUTPUT, IOEXP_PULLDOWN, 0);
	ioexp_gpio_set_cfg(CAM2_RST,		IOEXP_OUTPUT, IOEXP_PULLDOWN, 1);
}
