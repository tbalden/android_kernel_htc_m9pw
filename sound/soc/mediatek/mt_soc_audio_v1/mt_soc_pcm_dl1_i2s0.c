...
static int Audio_i2s0_SideGen_Set(struct snd_kcontrol *kcontrol, struct snd_ctl_elem_value *ucontrol)
{
    ...
    if (mi2s0_sidegen_control != 0)
    {
        ...
        if (GetMemoryPathEnable(Soc_Aud_Digital_Block_I2S_OUT_2) == false)
        {
            ...
            Afe_Set_Reg_I2S0_CHECK(AFE_I2S_CON, 0x0, 0x1, I2S0_FROM_DL1_I2S0);
            Afe_Set_Reg(AFE_I2S_CON3, 0x0, 0x1);
            udelay(200);
            SetMemoryPathEnable(Soc_Aud_Digital_Block_I2S_OUT_2, true);
            Afe_Set_Reg_I2S0_CHECK(AFE_I2S_CON, Audio_I2S_Dac | 0x1, MASK_ALL, I2S0_FROM_DL1_I2S0);
        ...
        if (true)
        {
            ...
            Afe_Set_Reg_I2S0_CHECK(AFE_I2S_CON, Audio_I2S_Dac, 0xFFFFFFFE, I2S0_FROM_DL1_I2S0);


            {
                
                uint32 MclkDiv0 = 0, MclkDiv3 = 0;
            ...
            Afe_Set_Reg(AFE_I2S_CON3, 0x01, 0x01);
            EnableAfe(true);
            udelay(500);
